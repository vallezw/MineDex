...
public class DBConnection {
    ...
    public void addUser(String user) throws SQLException, ClassNotFoundException {
        Connection con = getConnection();
    ...
    public void payUser(String sender, String receiver, int amount) throws SQLException, ClassNotFoundException {
        Connection con = getConnection();
        PreparedStatement pay = con.prepareStatement("UPDATE players SET coindex + " + String.valueOf(amount) + " WHERE username = '" + receiver +"'");
        pay.executeUpdate();
    ...
    private void removeCoinsFromUser(String sender, int amount) throws SQLException, ClassNotFoundException {
        Connection con = getConnection();
        PreparedStatement rem = con.prepareStatement("UPDATE players SET coindex - " + String.valueOf(amount) + " WHERE username = '" + sender + "'");
        rem.executeUpdate();
